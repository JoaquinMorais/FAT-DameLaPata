...
def sizes():
    ...
    db.session.add(State('en espera','estado en espera'))
    db.session.add(State('favoritos','estado favoritos'))
    ...
    db.session.add(RelationShipPetCharacteristics(5, 30))
    ...
    db.session.add(RelationShipPetCharacteristics(7, 30))
