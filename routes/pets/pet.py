...
def sizes():
    ...
    db.session.add(Characteristics('sin pierna', 'le falta una de sus piernas o mas'))
    db.session.add(Characteristics('castrado', 'sin posibilidad de tener crias'))
    ...
    #Vacunacion 
    db.session.add(Characteristics('Vacunado', 'El perro ha recibido todas las vacunas necesarias según el calendario de vacunación'))
    db.session.add(Characteristics('No vacunado', 'El perro no ha recibido todas las vacunas necesarias o no está actualizado en sus vacunas'))
    db.session.add(Characteristics('Programado para vacunas', 'El perro está en un programa de vacunación y recibirá sus vacunas en el futuro'))
    db.session.add(Characteristics('Vacunación parcial', 'El perro ha recibido algunas vacunas pero no todas'))
    db.session.add(Characteristics('Reacciones a las vacunas', 'El perro ha experimentado reacciones adversas a vacunas en el pasado'))
